    ...
    <>
        <tr className=' border-y border-gray-200 '>
            ...
            <td className='relative'> 
                ...
                {showMore && <div className='flex absolute top-0  right-20 z-50  gap-3 flex-col bg-white shadow-lg rounded-lg'>
                    {/* <button

                    className='flex  select-none  justify-start gap-3 hover:bg-gray-200 px-10 py-2 '>
                        <div>
